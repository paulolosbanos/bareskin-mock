...
public class RegisterSaleResponseTransformer extends NonGlobalResponseTransformer {
    public Response transform(Request request, Response response, FileSource fileSource, Parameters parameters) {
        ...
        return Response.Builder.like(response)
                .body(classpathFileSource.getTextFileNamed("register-sale-success.json").readContents())
                .build();
    }

    public String getName() {
        return "register-sale-transformer";
    }
}
