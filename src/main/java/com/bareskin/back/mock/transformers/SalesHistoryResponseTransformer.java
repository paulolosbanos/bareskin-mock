...
public class SalesHistoryResponseTransformer extends NonGlobalResponseTransformer {
    public Response transform(Request request, Response response, FileSource fileSource, Parameters parameters) {
        ...
        return Response.Builder.like(response)
                .body(classpathFileSource.getTextFileNamed("sales-history-success.json").readContents())
                .build();
    }

    public String getName() {
        return "sales-history-transformer";
    }
}
